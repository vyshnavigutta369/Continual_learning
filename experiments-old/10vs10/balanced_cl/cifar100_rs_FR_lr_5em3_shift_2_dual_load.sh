...
do
        ...
        do
                ...
                do           
                        ...
                        OUTDIR=_outputs/${DATE}/${OLD_VS_NEW}_${DATASET}/LR_${LR}_schedule_${SCHEDULE_TYPE}/replay_${RS}_shift_${SHIFT}_reverse/bh_reptype_${REPLAY_TYPE}_loss_${LOSS_TYPE}_dual_load${TEMP}
