...
do
        ...
        do
                ...
                do                
                        ...
                        OUTDIR=_outputs/${DATE}/twotask_${OLD_VS_NEW}_${DATASET}/LR_${LR}_schedule_${SCHEDULE_TYPE}/replay_${RS}/reptype_${REPLAY_TYPE}_loss_${LOSS_TYPE}_dist_shift/
                        PLOT_DIR=plots_and_tables/${DATE}/twotask_${OLD_VS_NEW}_${DATASET}/LR_${LR}_schedule_${SCHEDULE_TYPE}/replay_${RS}/reptype_${REPLAY_TYPE}_loss_${LOSS_TYPE}_dist_shift/
                ...
                #         OUTDIR=_outputs/${DATE}/twotask_${OLD_VS_NEW}_${DATASET}/LR_${LR}_schedule_${SCHEDULE_TYPE}/replay_${RS}/reptype_${REPLAY_TYPE}_loss_${LOSS_TYPE}_acc_shift/
                #         PLOT_DIR=plots_and_tables/${DATE}/twotask_${OLD_VS_NEW}_${DATASET}/LR_${LR}_schedule_${SCHEDULE_TYPE}/replay_${RS}/reptype_${REPLAY_TYPE}_loss_${LOSS_TYPE}_acc_shift/
