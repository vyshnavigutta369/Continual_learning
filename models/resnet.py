...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.last_balanced = nn.Linear(64, num_classes)
        self.last_unbalanced = nn.Linear(64, num_classes)

        # self.feat = nn.Sequential(*[self.conv1, self.bn1, self.layer1, self.layer2, self.layer3])
