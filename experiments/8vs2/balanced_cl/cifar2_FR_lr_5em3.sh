...
do
        ...
        do
                ...
                do                
                        ...
                        ORACLE_DIR=_outputs/Feb20/twotask_${OLD_VS_NEW}_${DATASET}/LR_${LR}_schedule_${SCHEDULE_TYPE}/Oracle/bh_reptype_${REPLAY_TYPE}_loss_${LOSS_TYPE}
                        ...
                        # OUTDIR=_outputs/${DATE}/twotask_${OLD_VS_NEW}_${DATASET}/LR_${LR}_schedule_${SCHEDULE_TYPE}/replay_${RS}/bc_reptype_${REPLAY_TYPE}_loss_${LOSS_TYPE}_shift_${SHIFT}${TEMP}
                        # PLOT_DIR=plots_and_tables/${DATE}/twotask_${OLD_VS_NEW}_${DATASET}/LR_${LR}_schedule_${SCHEDULE_TYPE}/bc_replay_${RS}/reptype_${REPLAY_TYPE}_loss_${LOSS_TYPE}_shift_${SHIFT}${TEMP}/
                        ...
                        #         --model_name $MODELNAME --model_type resnet \
                        #         --learner_type er --learner_name TR \
                        #         --log_dir ${OUTDIR} --plot_dir $PLOT_DIR --oracle_dir $ORACLE_DIR --with_class_balance 2
